...
class CheckSuite(unittest.TestCase):
    ...
    def test_forward_define_err_wrong_param_no_fail(self):
        input = """
        func foo(number a)
        number a <- 2
        func main() return
    ...
    #*Case 476-480: Array Cell type checking and type inference
    def test_array_cell_normal_flow(self):
        input = """
        func main()
        begin
            number b[2,2] <- [[1,2],[3,4]]
            var a <- b[0,1]
            a <- 3
            b[0,1] <- 2
            b[0] <- [3,4]
    ...
    def test_array_cell_type_mismatch(self):
        input = """
        func main()
        begin
            number b[2,2] <- [[1,2],[3,4]]
    ...
    def test_array_cell_type_inferred(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_array_cell_type_cannot_inferred_no_ele_type(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_array_cell_type_cannot_inferred_no_size(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    #*Case 781-790: Normal expr type checking and type inference
    def test_bin_expr_normal_flow(self):
        input = """
        func main()
        begin
            number a <- 2 + 3
    ...
    def test_bin_expr_type_mismatch(self):
        input = """
        func main()
        begin
            number a <- true + 3
    ...
    def test_bin_expr_type_inferred(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_bin_expr_type_inferred_failed(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_un_expr_normal_flow(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_un_expr_type_mismatch(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_un_expr_type_inferred(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_un_expr_type_inferred_failed(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    def test_array_lit_non_array_expr(self):
        input = """
        func main()
        begin
            var a <- 2
    ...
    def test_array_lit_non_number_size_expr(self):
        input = """
        func main()
        begin
            dynamic a
    ...
    #*case 491-500: Unique case
    def test_spec_code_piece_1(self):
        input = """
    ...
    def test_spec_code_piece_2(self):
        input = """
    ...
    def test_main_non_void_return(self):
        input = """
        func main()
        return 1
        """
    ...
    def test_redeclare_buildin(self):
        input = """
        func writeBool(bool anArg) return true
        func main()
        return 
        """
        expect = str(Redeclared(Function(), "writeBool"))
    ...
    def test_dynamic_var_no_used(self):
        input = """
        dynamic a
        func main()
        begin
